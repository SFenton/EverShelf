...
- **Canonical ingredients** — Products are mapped to common ingredient aliases and broader terms (e.g. "Chicken breast" → "Chicken") for better grouping and recipe matching
