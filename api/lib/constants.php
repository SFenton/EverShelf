...
define('USDA_FDC_CACHE_PATH',      EVERSHELF_ROOT . '/data/usda_fdc_lookup_cache.json');
...
define('GEMINI_COST_36F_IN',  (float)(getenv('GEMINI_COST_36F_IN')  ?: 1.50));
define('GEMINI_COST_36F_OUT', (float)(getenv('GEMINI_COST_36F_OUT') ?: 7.50));
define('GEMINI_COST_35FL_IN',  (float)(getenv('GEMINI_COST_35FL_IN')  ?: 0.30));
define('GEMINI_COST_35FL_OUT', (float)(getenv('GEMINI_COST_35FL_OUT') ?: 2.50));
