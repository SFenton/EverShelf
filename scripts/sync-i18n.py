...
FR_FILL: dict[str, str] = {
    ...
    'settings.info.pricing_note': 'Tarifs Gemini : 3-flash $0.50/M in · $3.00/M out — 2.5-flash $0.15/M in · $0.60/M out — 2.0-flash $0.10/M in · $0.40/M out.',
...
ES_FILL = {
    ...
    'settings.info.pricing_note': 'Precios Gemini: 3-flash $0.50/M in · $3.00/M out — 2.5-flash $0.15/M in · $0.60/M out — 2.0-flash $0.10/M in · $0.40/M out.',
